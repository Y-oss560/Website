          ...
          <Grid container spacing={2}>
            <Grid item md={8}>
              <div className="page-content">
                ...
                <p>
                  采用 Typescript
                  全面重构，守护进程经过大规模压力测试与多次内部测试，拥有更好的稳定性与可靠性。采用
                  90% 的 HTTP 接口和 20% 的 WebSocket
                  接口，几乎所有面板功能接口就是 API 接口。
                </p>
                <p></p>
              </div>
            </Grid>
          ...
          <Grid container spacing={10}>
            <Grid item md={6}>
              <div className="page-content">
                ...
                <p>
                  如果您是一位开发者，那么这些 API
                  接口相一定能够得到您的爱慕，我们提供了比上一代多两倍的接口与更齐全的数据格式。
                </p>
                <div className="button-group">
            ...
            <Grid item md={6}>
              <Grid container spacing={2}>
                <div className="page-content">
                  <h1>多节点集中控制</h1>
                  <p>
                    现在已经支持一个控制面板端集中管理控制多台远程主机，任意的远程主机均可供给任何面板端使用。
                  </p>
                  <p>
            ...
            <Grid item md={6}>
              <div className="page-content">
                ...
                <p>
                  在 Windows
                  下，您只需要下载压缩包双击即可运行面板，接下来的环境与相应配置面板将会自动完成。在
                  Linux 下也仅仅只需要使用一键安装脚本即可安装。
                </p>
              </div>
            </Grid>
            ...
            <Grid item md={6}>
              <div className="page-content">
                <h1>更优雅的网页设计</h1>
                <p>
                  使用 Vue 生态大部分技术与框架，重新设计 UI
                  与交互方式，打造出更优雅更实用的响应式前端网页。
                </p>
              </div>
            </Grid>
          </Grid>
        ...
        <Container maxWidth="lg">
            ...
            <Grid item md={8}>
              <div className="page-content">
                ...
                <p>
                  ...
                  <span className="text-weight">上榜官方赞助名单</span>和
                ...
                <div className="button-group">
                  <Button
                    ...
                    size="large"
                    onClick={() =>
                      window.open("https://afdian.net/@mcsmanager")
                    }
                  >
                    爱发电平台
                  </Button>
                  ...
                  <Button
                    ...
                    size="large"
                    onClick={() =>
                      window.open("https://jq.qq.com/?_wv=1027&k=kCZMJRBn")
                    }
                  >
                    加入QQ群
                  </Button>
          ...
          >
            <div style={{ textAlign: "center" }}>
              <h3>
                没有上述名单成员的支持与赞助，就不会有 MCSManager
                项目的长期维护。
              </h3>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item md={8}>
              <div className="page-content">
                <h1>旧版本迁移</h1>
                <p>
                  两者版本数据文件差异过大，无法直接升级迁移。如果您已经形成自己的产品链或部署一切正常，可以不必考虑迁移升级到
                  MCSManager 9 版本，您依然可以继续使用 MCSManager 8 版本。
                </p>
                <div className="button-group">
                  <a
                    className="button-alink"
                  ...
                  <a
                    className="button-alink"
                    href="https://github.com/Suwings/MCSManager/wiki/%E5%8D%87%E7%BA%A7%E5%88%B0-MCSManager-9.0"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <Button variant="contained" color="primary" size="large">
