...
export default function Main() {
  const [pageMainElement, setPageMainElement] = useState(null);
  ...
  function mouseMove(e) {
    ...
    const x = e.screenX / 10;
    const y = e.screenY / 10;
    if (pageMainElement) {
      pageMainElement.style.backgroundPositionX = `${x}px`;
      pageMainElement.style.backgroundPositionY = `${y}px`;
    }
  }
        ...
        >
          <div className="page-main-content" style={{ marginTop: "80px" }}>
            <h1>
              ...
              <span className="text-yellow">轻量级</span>和
              <span className="text-yellow">开箱即用</span>的 Minecraft 服务端
              <span className="text-yellow">管理面板</span>
            </h1>
            <p>
              现在处于内部开发测试中，有且只有赞助人员可以优先获得体验，您还无法免费下载它
            </p>
          </div>
        </Grid>
                  ...
                  <div style={{ padding: " 12px" }}>
                    ...
                    <p>
                      <Button
                        ...
                        disabled={true}
                      >
                        <DesktopWindowsIcon fontSize="inherit"></DesktopWindowsIcon>
                        &nbsp;下载 Windows 版本
                      </Button>
                    </p>
                    <p>
                      <Button
                        ...
                        disabled={true}
                      >
                        <DnsSharpIcon fontSize="inherit"></DnsSharpIcon>
                        &nbsp;下载 Linux 版本
                      </Button>
                    </p>
                    <p>源代码</p>
